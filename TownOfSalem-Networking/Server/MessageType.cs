namespace TownOfSalem_Networking.Server
{
    public enum MessageType
    {
        ...
        CaptchaResult = 0xE8,
        ReferralCodes = 0xE9,
        ReferralFeedback = 0xEA,
        TicketsOwned = 0xEB,
        PopupTicketInfo = 0xEC,
        TicketConsumed = 0xED,
        GeneralNotification = 0xEE,
        TraitorPlayer = 0xEF,
        DaysLeftToFindTraitor = 0xF0,
        AlternateGameRules = 0xF1,
    }
}